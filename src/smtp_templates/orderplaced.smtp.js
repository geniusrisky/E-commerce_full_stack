...
module.exports.orderplacedmail = async (name, email, amount, actionUrl) => {
    const HTML = `
                                                                ...
                                                                <table width="100%" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td style="padding-right: 0px;padding-left: 0px;"
                                                                            ...
                                                                            <img align="center" border="0"
                                                                                src="https://firebasestorage.googleapis.com/v0/b/copytoclipbord.appspot.com/o/images%2Fdata1657829802627order.png?alt=media&token=57bf7b2f-b3df-42a0-aa19-30991f5d4886"
                                                                                alt="" title=""
                                                            ...
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="font-size: 14px; line-height: 200%;"><span
                                                                            style="font-size: 26px; line-height: 52px;">Order
                                                            ...
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="font-size: 14px; line-height: 160%;"><span
                                                                            ...
                                                                            Order of Rs. ${amount}/- is placed successfully.
                                                                            Please click on the button below to view order
                                                                            details. </span></p>
                                                                </div>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;"
                                                                ...
                                                                <div align="center">
                                                                    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;font-family:'Cabin',sans-serif;"><tr><td style="font-family:'Cabin',sans-serif;" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:46px; v-text-anchor:middle; width:247px;" arcsize="8.5%" stroke="f" fillcolor="#66d695"><w:anchorlock/><center style="color:#FFFFFF;font-family:'Cabin',sans-serif;"><![endif]-->
...
`;
    ...
    return await smtp("Order Placed - No Reply", email, "Order Placed", HTML);
}