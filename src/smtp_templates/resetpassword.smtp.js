...
module.exports.resetpasswordrequest = async (name, email, actionUrl) => {
    const HTML = `
    <!DOCTYPE HTML
                                                                ...
                                                                <table width="100%" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td style="padding-right: 0px;padding-left: 0px;"
                                                                            ...
                                                                            <img align="center" border="0"
                                                                                src="https://firebasestorage.googleapis.com/v0/b/copytoclipbord.appspot.com/o/images%2Fdata1657884703020key.png?alt=media&token=b064f815-8604-46e7-94c9-8fb7840c1c7d"
                                                                                alt="" title=""
                                                                                style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 128px;"
                                                                                width="128"
                                                                                class="v-src-width v-src-max-width" />
                                                            ...
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="font-size: 14px; line-height: 200%;"><span
                                                                            style="font-size: 26px; line-height: 52px;">Reset
                                                                            Password!</span></p>
                                                                </div>
                                                            ...
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="font-size: 14px; line-height: 160%;"><span
                                                                            ...
                                                                            received a request to reset the password for
                                                                            your account. To reset your password, click the
                                                                            button given below.</span></p>
                                                                </div>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;"
                                                                ...
                                                                <div align="center">
                                                                    <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;font-family:'Cabin',sans-serif;"><tr><td style="font-family:'Cabin',sans-serif;" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:46px; v-text-anchor:middle; width:224px;" arcsize="8.5%" stroke="f" fillcolor="#66d695"><w:anchorlock/><center style="color:#FFFFFF;font-family:'Cabin',sans-serif;"><![endif]-->
                                                                    <a href="${actionUrl}" target="_blank"
                                                                        style="box-sizing: border-box;display: inline-block;font-family:'Cabin',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #66d695; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;">
                                                                        <span
    ...
    return await smtp("Reset Password - No Reply", email, "Reset Password", HTML);
}